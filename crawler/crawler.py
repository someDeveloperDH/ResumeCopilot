...
실행 (test4 루트에서):
    python crawler/crawler.py                              # 기본 실행 (ID 30000~37000)
    python crawler/crawler.py --start-id 34000             # 중단 후 재개
    python crawler/crawler.py --output-dir ./data/stage1   # 저장 경로 지정
    python crawler/crawler.py --status                     # 현재 수집 현황만 출력
"""
